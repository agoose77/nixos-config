      ...
      cameras = {
        ...
        garden = {
          ...
          zones = {
            ...
            Raised_Garden = {
              coordinates = "0.37,0.271,0.733,0,1,0,1,0.768";
              loitering_time = 0;
            };
            Patio = {
              coordinates = "0.356,0.267,0.091,0.513,0.324,0.899,0.25,1,0.999,0.996,1,0.773";
        ...
        doorbell = {
          ...
          motion.mask = [
            "0,0.263,0.056,0.34,0.082,0.332,0.145,0.361,0.175,0.404,0.324,0.4,0.397,0.469,0.455,0.467,0.591,0.324,0.609,0.271,0.659,0.266,0.705,0.222,0.749,0.204,0.808,0.157,0.89,0.34,0.902,0.425,0.929,0.422,0.931,0.377,0.994,0.359,1,0,0.001,0.002"
          ];
          zones = {
            Doorstep = {
